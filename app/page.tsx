        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="text-center sm:text-right flex-grow">
              <p className="text-white font-semibold text-sm sm:text-base m-0 mb-1">סטודיו סשה Tattoos</p>
              <p className="text-zinc-300 text-xs sm:text-sm m-0 mb-0.5">עליזה בגין 123 טבריה</p>
              <p className="text-zinc-300 text-xs sm:text-sm m-0">052-620-2701</p>
            </div>

            {/* Copyright Section */}
            <div className="text-center sm:text-left flex-grow sm:flex-grow-0">
              <p className="text-zinc-500 text-xs m-0 mb-1">© {new Date().getFullYear()} סטודיו סשה Tattoos</p>
              <p className="text-zinc-600 text-[10px] m-0">All rights reserved Shoam Taitler</p>
            </div>
          </div>
        </div>
      </footer>
